...
\title{\pkg{biblatex-chem} -- A set of \pkg{biblatex} implementations of
  chemistry-related bibliography styles%
  \footnote{This file describes v1.2, last revised 2025-08-04.}}
...
\changes{v1.2}{2025-08-04}{Correct punctuation between author list and book title}
...
%% 
%% Copyright (C) 2010-2014,2016-2019,2021,2025 by
